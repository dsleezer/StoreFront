...
namespace StoreFront.UI.MVC.Controllers
{
    ...
    public class StockStatusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StockStatusId,StatusName")] StockStatus stockStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StockStatusId,StatusName")] StockStatus stockStatus)
        {
